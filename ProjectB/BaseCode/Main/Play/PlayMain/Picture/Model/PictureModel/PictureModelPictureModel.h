...
@class PictureModelLuaVersions;

@interface PictureModelPictureModel : NSObject <NSCoding, NSCopying>
...
@property (nonatomic, strong) PictureModelLuaVersions *luaVersions;
