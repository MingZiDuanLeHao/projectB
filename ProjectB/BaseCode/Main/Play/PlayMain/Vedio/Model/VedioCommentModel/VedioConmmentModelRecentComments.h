//
//  VedioConmmentModelRecentComments.h
//
...
@interface VedioConmmentModelRecentComments : NSObject <NSCoding, NSCopying>
...
@property (nonatomic, assign) double recentCommentsIdentifier;
@property (nonatomic, strong) NSString *platform;
@property (nonatomic, assign) double userDigg;
@property (nonatomic, strong) NSString *userProfileImageUrl;
@property (nonatomic, strong) NSString *text;
@property (nonatomic, strong) NSString *recentCommentsDescription;
